...
#
# Builds the static db-lib + tds + replacements + tdsutils from the
# external/freetds submodule and merges them into one static library
# `freetds_sybdb`. OpenSSL comes from vcpkg.
#
...
if(WIN32)
    ...
    ExternalProject_Add(
        ...
        BUILD_COMMAND
            ${CMAKE_COMMAND} --build <BINARY_DIR> --config Release --target db-lib tds replacements tdsutils
        INSTALL_COMMAND
